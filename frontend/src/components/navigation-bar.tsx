      ...
      <nav className="bg-purple-900">
        <div className="flex w-full items-center h-20 px-7">
          <div className="flex items-center justify-between">
            <Image src="/companyLogo.png" alt="logo" width={50} height={50} />
            <p className="text-3xl text-white font-semibold">City Traveling</p>
          </div>
          <Button className="ml-auto bg-black rounded-md h-10 w-40 text-xl text-white font-semibold"><Link href="/auth">Login</Link></Button>
        </div>  
      </nav>
  );
}